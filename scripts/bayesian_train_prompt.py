# bayesian_train_prompt.py
#
# Purpose
#   Run Bayesian hyperparameter search (Optuna) for Prompt-Tuning training.
#   This is the PROMPT counterpart to bayesian_train_lora.py / bayesian_train_prefix.py,
#   designed to keep the workflow consistent across LoRA vs Prefix vs Prompt experiments.
#
# What this script does (per Optuna trial)
#   1) Samples hyperparameters from the predefined search spaces:
#        - learning rate (learning_rates)
#        - number of virtual prompt tokens p (n_prompt_tokens)  -> passed as --n_prompt_token
#
...
#   - learning_rates, n_prompt_tokens, contrastive_ratios, kl_ratios
#
# Usage
#   python bayesian_train_prompt.py
#
# Output
...
def objective(trial: optuna.Trial) -> float:
    ...
    npt = trial.suggest_categorical("n_prompt_token", n_prompt_tokens)
